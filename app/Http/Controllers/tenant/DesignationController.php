    ...
    try {
      ...
      return DataTables::eloquent($query)
        ...
        ->addColumn('action', function ($designation) {
          $editBtn = '<button class="btn btn-sm btn-icon edit-record" data-id="' . $designation->id . '" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddOrUpdateDesignation"><i class="bx bx-edit"></i></button>';
          $deleteBtn = '<button class="btn btn-sm btn-icon delete-record" data-id="' . $designation->id . '"><i class="bx bx-trash"></i></button>';

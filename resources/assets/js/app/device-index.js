        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<button class="btn btn-sm btn-icon device-status-details" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDeviceStatusDetails"><i class="bx bx-show"></i></button>` +
